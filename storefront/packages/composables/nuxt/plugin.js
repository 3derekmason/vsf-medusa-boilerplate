...
import cookie from '@vue-storefront/medusa/nuxt/cookie';
import defaultConfig from '@vue-storefront/medusa/nuxt/config/defaultConfig';
import { mapConfigToSetupObject } from '@vue-storefront/medusa/nuxt/helpers/settings';
...
export default integrationPlugin(({ app, res, req, integration }) => {
  ...
  integration.configure('medusa', settings);
});
